#[tauri::command]
pub fn read_rsf_config(rbr_install_path: String) -> Result<String, String> {
...
#[tauri::command]
pub fn write_rsf_config(rbr_install_path: String, content: String) -> Result<(), String> {
    let rbr_config_path = get_config_path(rbr_install_path);
...
fn get_config_path(rbr_install_path: String) -> String {
    format!("{}/RallySimFans.ini", rbr_install_path)
}
